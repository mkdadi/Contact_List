...
public class CApplet extends JApplet {
	...
	public void init() {
		URL url=getCodeBase();
			try{
				BufferedWriter writer=new BufferedWriter(new FileWriter(url+"relatives.txt"));
			...
			try{
				BufferedWriter writer=new BufferedWriter(new FileWriter(url+"personals.txt"));
			...
			try{
				BufferedWriter writer=new BufferedWriter(new FileWriter(url+"professionals.txt"));
			...
			try{
				BufferedWriter writer=new BufferedWriter(new FileWriter(url+"casuals.txt"));
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for(int i2=0;i2<prFriends.size();i2++)
				{
					JButton button=new JButton(prFriends.get(i2).name);
					button.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							disA.setVisible(false);
							JButton button=(JButton)e.getSource();
					...
					button.putClientProperty("id", i2);
					ACPane.add(button);
				}
		...
		button_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				URL url=getCodeBase();
				try{
					BufferedReader bReader=new BufferedReader(new FileReader(url+"relatives.txt"));
				...
				{}
				try{
					BufferedReader bReader=new BufferedReader(new FileReader(url+"personals.txt"));
					String temp=new String(bReader.readLine());
					while(temp!=null)
					{
				...
				{}
				try{
					BufferedReader bReader=new BufferedReader(new FileReader(url+"professionals.txt"));
					String temp=new String(bReader.readLine());
					while(temp!=null)
					{
				...
				{}
				try{
					BufferedReader bReader=new BufferedReader(new FileReader(url+"casuals.txt"));
					String temp=new String(bReader.readLine());
					while(temp!=null)
					{
